...
unit NeoFlat.MessageBoxForm;

interface

uses
  Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics,
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, NeoFlat.Panel, NeoFlat.CaptionBar, NeoFlat.Form,
  Vcl.Imaging.pngimage, Vcl.ExtCtrls, NeoFlat.Button, Vcl.StdCtrls, VCL.Consts,
...
begin
  FResult := TFlatButton(Sender).Value;
